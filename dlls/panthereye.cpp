...
{
	"panthereye/claw_strike1.wav",
	"panthereye/claw_strike2.wav",
	"panthereye/claw_strike3.wav",
};

const char *CPantherEye::pAttackMissSounds[] =
{
	"panthereye/claw_miss1.wav",
	"panthereye/claw_miss2.wav",
};
...
int CPantherEye::TakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType )
{
