...
#define WEAPON_EAGLE			28
#define WEAPON_PIPEWRENCH		29
#define	WEAPON_PENGUIN			30
#define WEAPON_SPORELAUNCHER		31
#define WEAPON_NUKE			32
#define WEAPON_CHAINGUN			33
#define WEAPON_UZI				34
#define WEAPON_USP				35
#define WEAPON_HAMMER 	36
#define WEAPON_AK47				37
...
typedef	enum
{
	...
	BULLET_PLAYER_USP,//CS USP
	BULLET_PLAYER_AK47,//CS AK47
...
public:
	...
	int		TakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType ); // PHYSICS
	virtual BOOL UseDecrement( void )
	{ 
#if defined( CLIENT_WEAPONS )
		return TRUE;
...
private:
	unsigned short m_usp;
	unsigned short m_usp_unsil;
};
