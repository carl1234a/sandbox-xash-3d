...
cvar_t sk_50cal_bullet1 = {"sk_50cal_bullet1","0"};
cvar_t sk_50cal_bullet2 = {"sk_50cal_bullet2","0"};
cvar_t sk_50cal_bullet3 = {"sk_50cal_bullet3","0"};
...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	CVAR_REGISTER ( &sk_50cal_bullet1 );
	CVAR_REGISTER ( &sk_50cal_bullet2 );
	CVAR_REGISTER ( &sk_50cal_bullet3 );
	...
	// CS USP Round
	CVAR_REGISTER ( &sk_plr_USP_bullet1 );// {"sk_plr_usp_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_USP_bullet2 );// {"sk_plr_usp_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_USP_bullet3 );// {"sk_plr_usp_bullet3","0"};
	...
	// CS AK47 Round
	CVAR_REGISTER ( &sk_plr_AK47_bullet1 );// {"sk_plr_DESERT_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_AK47_bullet2 );// {"sk_plr_DESERT_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_AK47_bullet3 );// {"sk_plr_DESERT_bullet3","0"};
