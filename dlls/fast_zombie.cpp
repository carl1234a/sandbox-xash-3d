...
{
	"fastzombie/claw_strike1.wav",
	"fastzombie/claw_strike2.wav",
	"fastzombie/claw_strike3.wav",
};

const char *CFastZombie::pAttackMissSounds[] = 
{
	"fastzombie/claw_miss1.wav",
	"fastzombie/claw_miss2.wav",
};

const char *CFastZombie::pAttackSounds[] = 
{
	"fastzombie/zo_attack1.wav",
	"fastzombie/zo_attack2.wav",
};

const char *CFastZombie::pIdleSounds[] = 
{
	"fastzombie/idle1.wav",
	"fastzombie/idle2.wav",
	"fastzombie/idle3.wav",
	"fastzombie/idle4.wav",
};

const char *CFastZombie::pAlertSounds[] = 
{
	"fastzombie/fz_alert_close1.wav",
	"fastzombie/fz_far1.wav",
	"fastzombie/fz_frenzy1.wav",
};

const char *CFastZombie::pPainSounds[] = 
{
	"fastzombie/leap1.wav",
	"fastzombie/wake1.wav",
};
